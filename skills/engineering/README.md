...
| [`pair`](./pair/SKILL.md) | User-invoked (`/pair`). Pair-programming mode: one move per turn, keyboard handed back at a live decision point, the small things treated as the real work. |

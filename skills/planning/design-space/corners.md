...
A **corner** is a concept pinned at the extremes of the axes and followed all the way through.
Four to six of them, deliberately incompatible, presented flat.

The point is not to find the answer. It is to make the space visible, so that whatever gets built
is chosen against real alternatives instead of being the first thing that cohered.

## What a corner is

| | |
| --- | --- |
| **Name** | Two or three words, in the product's world. `The Ledger`, not `Option B`. The name is what the user will argue with a week later. |
| **Thesis** | One line. What this corner believes that the others do not. |
| **Position** | Where it sits on every axis. A corner that sits mid-way on all of them is not a corner. |
...
- **Remove the obvious element.** No dashboard. No nav. No list. No search. Whatever the category
...
The corners come back looking like one idea in four hats when any of these fire:

- **The rename trap.** Four corners that differ only in tone words. If the *structure* is the same,
  you generated one corner and four descriptions of it.
